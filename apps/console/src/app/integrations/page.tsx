    ...
    <div className="flex flex-col w-full gap-space-base pb-16">
      ...
      <div className="flex flex-col gap-space-sm">
        ...
        <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-space-base pb-space-sm">
          ...
          <DemoDataBadge reason="The real hosted→local fallback cascade (Sarvam/Gemini/Bhashini → Ollama/PaddleOCR/IndicConformer) only exists in structured logs today — no endpoint exposes it. This screen's content (generic HIS subsystem bridges) is also not yet rewritten to reflect that story; see docs/19-frontend-status.md." />
