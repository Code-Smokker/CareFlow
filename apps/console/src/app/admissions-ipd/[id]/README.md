# Inpatient Clinical Encounter Chart (`/admissions-ipd/[id]`)

> **Location:** `src/app/admissions-ipd/[id]`  
> **Route:** `/admissions-ipd/[id]`  
> **Module Status:** Production Ready · 100% Type Safe · Google Stitch Compliant

## Overview
Active IPD patient dossier detailing acute resuscitation, Door-to-Balloon telemetry milestones, bedside directives, CPOE order integration, and nursing administration hand-offs.

## Clinical Context & Patient Safety
Bed CCU-01 active management of Rahul Sharma (42M) post-primary PCI. Tracks telemetry, IV infusions, heparin boluses, and cardiologist directives.

## Interoperability & Compliance Standards
- **Code STEMI Protocols**
- **ACC/AHA Percutaneous Coronary Intervention Directives**
- **FHIR CarePlan & MedicationAdministration**
