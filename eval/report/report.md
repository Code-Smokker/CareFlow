...
Slot accuracy — messy/extraction cases          10/12  via /fill-slot, 10/12 calls answered by a live LLM provider
----------------------------------------------------------------------------------------
Per-script detail:
  ...
  [FAIL] messy_mumbling_abdominal.duration             expected='3_days' actual='2_days' (needs_clarification)
  [PASS] messy_mumbling_abdominal.associated           expected=['black_stool'] actual=['black_stool']
  [FAIL] messy_mumbling_fever.duration             expected='3_days' actual='2_days' (needs_clarification)
