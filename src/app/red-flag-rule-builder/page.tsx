...
export default function RedFlagRuleBuilderPage() {
  ...
  const [isSubmitBoardOpen, setIsSubmitBoardOpen] = useState(false);
  ...
  // Tune thresholds
  const [femaleStThreshold, setFemaleStThreshold] = useState("1.5");
  const [maleStThreshold, setMaleStThreshold] = useState("2.0");
  const [troponinThreshold, setTroponinThreshold] = useState("0.04");
  const [evalLatencyLimit, setEvalLatencyLimit] = useState("25");
    ...
    <div className="flex flex-col w-full pb-16">
      ...
      <div className="flex flex-col gap-space-sm mb-space-base">
        <div className="flex items-center gap-space-xs text-metadata-micro font-metadata-micro text-outline">
          ...
          <Link href="/clinical-rules-protocols" className="hover:text-primary transition-colors">
        ...
        <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-space-base pb-space-sm">
          ...
          <div className="flex flex-wrap items-center gap-space-xs">
            ...
            <button
              onClick={() => showToast("Draft snapshot saved to clinical rules local buffer.")}
              className="flex items-center gap-space-xs px-space-md py-1.5 bg-surface-container-low hover:bg-surface-container rounded-xl text-on-surface-variant hover:text-on-surface font-clinical-data text-clinical-data transition-colors border border-outline-variant/10"
            >
            ...
            <button
              onClick={() => setIsSubmitBoardOpen(true)}
              className="flex items-center gap-space-xs px-space-md py-1.5 bg-secondary hover:bg-secondary/90 rounded-xl text-on-secondary font-clinical-data text-clinical-data transition-colors shadow-sm"
            >
              <span className="material-symbols-outlined text-base">approval</span>
              <span>Submit to Clinical Board</span>
            </button>

            <button
              onClick={() => showToast("Rule RF-CARD-01 is cryptographically active and locked against autonomous AI mutation.")}
              className="flex items-center gap-space-xs px-space-lg py-1.5 bg-primary hover:bg-primary-container text-on-primary font-clinical-data text-clinical-data font-semibold rounded-xl shadow-md transition-all"
            >
              <span className="material-symbols-outlined text-base">verified_user</span>
              <span>Rule Active &amp; Locked</span>
            </button>
          </div>
        </div>
      </div>
            ...
            <div className="flex items-center justify-between pb-space-sm border-b-0">
              ...
              <div className="flex items-center gap-space-xs">
                ...
                <button
                  ...
                  className="ml-2 p-1 text-on-surface-variant hover:text-on-surface hover:bg-surface-container rounded transition-colors"
                  title="Tune Parameters & Thresholds"
                >
      ...
      {/* Modal: Submit to Clinical Board */}
      {isSubmitBoardOpen && (
        <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-surface-container-lowest rounded-xl shadow-xl w-full max-w-md border border-outline-variant/30 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="p-space-base border-b border-surface-container-high flex items-center justify-between">
              <div className="flex items-center gap-space-xs">
                <span className="material-symbols-outlined text-secondary text-xl">approval</span>
                <h3 className="font-section-title text-section-title text-on-surface font-semibold">
                  Submit Rule to Governance Board
                </h3>
              </div>
              <button
                onClick={() => setIsSubmitBoardOpen(false)}
                className="p-1 rounded-md text-outline hover:text-on-surface hover:bg-surface-container"
              >
                <span className="material-symbols-outlined text-sm">close</span>
              </button>
            ...
            <div className="p-space-base flex flex-col gap-space-sm text-clinical-data text-on-surface">
              <p className="text-metadata-micro text-on-surface-variant leading-relaxed">
                Submitting version <strong>v2.4 (Active Enforced)</strong> of Rule #RF-CARD-01 for expedited review by the Apollo Indraprastha Clinical Executive Council.
              </p>
              ...
              <div className="p-space-sm bg-surface-container-low rounded-lg flex flex-col gap-1 border border-outline-variant/10 font-clinical-data-mono text-metadata-micro">
                <div className="flex justify-between">
                  <span className="text-outline">Proposing Lead:</span>
                  <span className="font-semibold text-on-surface">Dr. Rohit Verma (Chief)</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-outline">Board Reviewers:</span>
                  <span className="text-on-surface">Dr. A. Mathur, Dr. S. Kulkarni</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-outline">Audit Checksum:</span>
                  <span className="text-primary font-semibold">SHA256:4096-RSA</span>
                </div>
              </div>
              ...
              <div className="pt-space-xs flex items-center justify-end gap-space-xs border-t border-surface-container-high">
                ...
                <button
                  type="button"
                  onClick={() => {
                    setIsSubmitBoardOpen(false);
                    showToast("Rule dossier submitted to Apollo Clinical Governance Board. Tracking ID #REV-2024-819.");
                  }}
                  className="px-space-lg py-1.5 rounded-lg bg-secondary hover:bg-secondary/90 text-on-secondary font-clinical-data text-clinical-data font-semibold shadow-sm transition-all"
                >
                  Confirm Submission
                </button>
              </div>
        ...
        <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-surface-container-lowest rounded-xl shadow-xl w-full max-w-md border border-outline-variant/30 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="p-space-base flex flex-col gap-space-sm">
              <div className="flex flex-col gap-1">
                <label className="text-metadata-micro text-outline uppercase font-semibold">
                  Female ST-Elevation Cutoff (mm in V2-V3)
                </label>
                <input
                  type="number"
                  step="0.1"
                  value={femaleStThreshold}
                  onChange={(e) => setFemaleStThreshold(e.target.value)}
                  className="h-8 px-2 rounded bg-surface-container-low border border-outline-variant text-clinical-data font-clinical-data text-on-surface font-clinical-data-mono"
                />
              </div>

              <div className="flex flex-col gap-1">
                <label className="text-metadata-micro text-outline uppercase font-semibold">
                  Male ST-Elevation Cutoff (mm in V2-V3)
                </label>
                <input
                  type="number"
                  step="0.1"
                  value={maleStThreshold}
                  onChange={(e) => setMaleStThreshold(e.target.value)}
                  className="h-8 px-2 rounded bg-surface-container-low border border-outline-variant text-clinical-data font-clinical-data text-on-surface font-clinical-data-mono"
                />
              </div>
              ...
              <div className="flex flex-col gap-1">
                <label className="text-metadata-micro text-outline uppercase font-semibold">
                  hs-cTnI Troponin URL Cutoff (ng/mL)
                </label>
                <input
                  type="number"
                  step="0.01"
                  value={troponinThreshold}
                  onChange={(e) => setTroponinThreshold(e.target.value)}
                  className="h-8 px-2 rounded bg-surface-container-low border border-outline-variant text-clinical-data font-clinical-data text-on-surface font-clinical-data-mono"
                />
              </div>
              ...
              <div className="flex flex-col gap-1">
                <label className="text-metadata-micro text-outline uppercase font-semibold">
                  Max Evaluation Latency Bound (ms)
                </label>
                <input
                  type="number"
                  value={evalLatencyLimit}
                  onChange={(e) => setEvalLatencyLimit(e.target.value)}
                  className="h-8 px-2 rounded bg-surface-container-low border border-outline-variant text-clinical-data font-clinical-data text-on-surface font-clinical-data-mono"
                />
              </div>
              ...
              <div className="pt-space-xs flex items-center justify-end gap-space-xs border-t border-surface-container-high">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    showToast("Updated DFA boundary parameters and re-compiled deterministic bytecode.");
                  }}
                  className="px-space-lg py-1.5 rounded-lg bg-primary hover:bg-primary-container text-on-primary font-clinical-data text-clinical-data font-semibold shadow-sm transition-all"
                >
                  Apply &amp; Recompile
